...
Shader "Slate/Flag"
{
    Properties
    {
        ...
        _BaseMap ("Arms (optional)", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                half3 arms = SAMPLE_TEXTURE2D(_BaseMap, sampler_BaseMap, IN.uv).rgb;
                half3 col = arms * _BaseColor.rgb * IN.shade * (0.35h + 0.75h * mainLight.color);
